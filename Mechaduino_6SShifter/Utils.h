...
#define __UTIL_H__
	...
	void setupPins();                 // initializes I/O pins
	void setupSPI();                  //initializes SPI

  void configureStepDir();          //configure step/dir interface for host MCU to use Mechaduino like a servo.
