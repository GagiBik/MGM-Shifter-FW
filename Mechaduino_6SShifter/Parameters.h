...
extern volatile int adcAverage;
extern volatile int magneticOffset;
extern volatile float gearRatio;
extern volatile float gearAngle;
...
extern const float stepangle; // microstep angle

extern volatile float PA;     // Phase advance


// PWM parameters for current control
...
#define IN_1  8
#define ledPin  13
#define chipSelectPin A2 // Encoder chip select
