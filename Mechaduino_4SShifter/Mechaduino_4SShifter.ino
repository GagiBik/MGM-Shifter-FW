...
//Gear up positions:
#define up1s -208 + magneticOffset
...
void gearTest3(){
  ...
  //r = 60;
  //delay(delayMS);
  r = -(46*gearRatio) + magneticOffset;       //1 start
  delay(delayMS);
  r = -(66*gearRatio) + magneticOffset;       //1 mid
  delay(delayLong);
  r = -(107*gearRatio) + magneticOffset;       //1 end  
  delay(delayMS);                        //nutral
  r = -(112*gearRatio) + magneticOffset;       //2 start   // 590, has grinding
  delay(delayMS);
  r = -(155*gearRatio) + magneticOffset;       //2 mid
  delay(delayLong);
  r = -(189*gearRatio) + magneticOffset;       //2 end
  delay(delayMS);
  r = -(207*gearRatio) + magneticOffset;       //3 start
  delay(delayMS);
  r = -(232*gearRatio) + magneticOffset;       //3 mid
  delay(delayLong);
  r = -(257*gearRatio) + magneticOffset;       //3 end
  delay(delayMS);
  r = -(265*gearRatio) + magneticOffset;       //4 start
  delay(delayMS);
  r = -(284*gearRatio) + magneticOffset;       //4 mid & end
  delay(delayLong);
  // r = -1530;       //dead end
  // delay(500);
...
// gear down
  ...
  r = -(155*gearRatio) + magneticOffset;       //2 mid
  delay(delayLong);
  r = -(112*gearRatio) + magneticOffset;       //2 start
  delay(delayMS);
  r = -(107*gearRatio) + magneticOffset;       //1 end
  delay(delayMS);
  r = -(66*gearRatio) + magneticOffset;       //1 mid         
  ...
  r = -(46*gearRatio) + magneticOffset;       //1 start
  delay(delayMS);
  r = -(0*gearRatio) + magneticOffset;           // Nutral
  delay (delayLong);
}
